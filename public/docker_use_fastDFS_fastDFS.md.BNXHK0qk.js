import{_ as s,c as a,o as i,a3 as n}from"./chunks/framework.B_66xkI7.js";const D=JSON.parse('{"title":"FastDFS","description":"","frontmatter":{},"headers":[],"relativePath":"docker/use/fastDFS/fastDFS.md","filePath":"docker/use/fastDFS/fastDFS.md"}'),l={name:"docker/use/fastDFS/fastDFS.md"},p=n(`<h1 id="fastdfs" tabindex="-1">FastDFS <a class="header-anchor" href="#fastdfs" aria-label="Permalink to &quot;FastDFS&quot;">​</a></h1><nav class="table-of-contents"><ul><li><a href="#fastdfs">FastDFS</a><ul><li><a href="#docker-compose">docker-compose</a></li><li><a href="#nginx">nginx</a></li><li><a href="#使用方式">使用方式</a></li></ul></li></ul></nav><h2 id="docker-compose" tabindex="-1">docker-compose <a class="header-anchor" href="#docker-compose" aria-label="Permalink to &quot;docker-compose&quot;">​</a></h2><blockquote><p>docker-compose</p></blockquote><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965;">services</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">:</span></span>
...
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD;">  #}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE;">}</span></span></code></pre></div><h2 id="使用方式" tabindex="-1"><a href="./README.html">使用方式</a> <a class="header-anchor" href="#使用方式" aria-label="Permalink to &quot;[使用方式](./README)&quot;">​</a></h2>`,9),e=[p];function t(h,k,r,d,c,o){return i(),a("div",null,e)}const g=s(l,[["render",t]]);export{D as __pageData,g as default};
