...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">i18n.locale</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">zh-CN</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> # 中文</span></span></code></pre></div><h2 id="ik分词器" tabindex="-1">ik分词器 <a class="header-anchor" href="#ik分词器" aria-label="Permalink to &quot;ik分词器&quot;">​</a></h2><p><a href="../../public/elasticsearch/plugin/ik.zip">ik分词器</a></p>`,10),e=[l];function t(h,k,r,c,E,d){return n(),a("div",null,e)}const y=s(p,[["render",t]]);export{o as __pageData,y as default};
